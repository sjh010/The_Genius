		...
		<div class="container-body">
			<form class="form-horizontal" role="form" id="user-join-form">
				<div class="form-group ">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control input-short" name="user_id"
							placeholder="5자리 이상 영문 소문자/숫자"> <label
							class="control-label user-id-msg"></label>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="password" class="form-control input-short"
							name="user_pw"> <label class="control-label user-pw-msg"></label>
					</div>
				</div>
				<div class="form-group">
					<label for="user_pwck" class="col-sm-2 control-label">비밀번호
						확인</label>
					<div class="col-sm-10">
						<input type="password" class="form-control input-short"
							name="user_pwck"> <label
							class="control-label user-pwck-msg"></label>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="btn-group" data-toggle="buttons">
							<label class="btn btn-default"> <input type="radio"
								...
								type="radio" name="user_sex" checked="">여자
							</label>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10 zipcode">
						<span><input type="text" class="form-control"
							name="zipcode1"></span> <span>-</span> <span><input
							type="text" class="form-control" name="zipcode2"></span> <span><button
								class="btn btn-default" id="searchZipcode">우편번호 검색</button></span>
					</div>
				</div>
				<div class="form-group">
					<label for="address" class="col-sm-2 control-label">주소</label>
					<div class="col-sm-10 ">
						<input type="text" class="form-control address input-long"
							name="address1"> <input type="text"
							class="form-control input-long" name="address2">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						</select> <span>-</span> <input type="text" class="form-control mobile"
							name="phone2" /> <span>-</span> <input type="text"
							class="form-control mobile" name="phone3" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control mobile" name="mobile1">
							...
							name="mobile2" /> <span>-</span> <input type="text"
							class="form-control mobile" name="mobile3" />
					</div>
				</div>
				<div class="form-group">
